...
{iso:'2026-10-03T12:30:00+01:00',time:'12:30',title:'继续下坡 → 下城 Baixa / Rossio',sub:'到12:50；不折返',place:'rossio',icon:'🚶'},
{iso:'2026-10-03T12:50:00+01:00',time:'12:50',title:'午饭',sub:'12:50–13:35；Baixa/Rossio灵活选，排队>15–20分钟就换',place:'rossio',icon:'🍽️'},
{iso:'2026-10-03T13:35:00+01:00',time:'13:35',title:'下城 Baixa / Rossio → Cais do Sodré',sub:'方便连接即可',place:'cais',icon:'🚇'},
{iso:'2026-10-03T14:00:00+01:00',time:'~14:00',title:'Cais do Sodré车站 → 贝伦 Belém',sub:'CP Cascais Line；周末班次临近再看',place:'cais',icon:'🚆'},
...
{iso:'2026-10-03T16:50:00+01:00',time:'16:50',title:'贝伦 Belém 河岸步行',sub:'约25分钟；可压缩',place:'belem',icon:'🚶',buffer:true},
{iso:'2026-10-03T17:15:00+01:00',time:'17:15',title:'贝伦塔 Torre de Belém',sub:'外观到17:40；时间紧可取消',place:'belem',icon:'🗼',buffer:true},
{iso:'2026-10-03T17:40:00+01:00',time:'约17:40后',title:'贝伦 Belém → ibis 酒店',sub:'火车 + 地铁；太累就 Uber。晚上吃饭后休息',place:'ibis',icon:'🚆'}]},
...
{iso:'2026-10-04T09:00:00+01:00',time:'~09:00',title:'步行 → 西班牙广场站 Praça de Espanha 北厅',sub:'South Hall施工期不依赖',place:'ibis',icon:'🚶'},
{iso:'2026-10-04T09:05:00+01:00',time:'~09:05',title:'西班牙广场站 Praça de Espanha → Terreiro do Paço',sub:'Blue Line direct',place:'comercio',icon:'🚇'},
...
{iso:'2026-10-04T10:15:00+01:00',time:'10:15',title:'罗西欧 Rossio → 卡尔莫广场 Largo do Carmo',sub:'有一些上坡',place:'carmo',icon:'🚶'},
...
{iso:'2026-10-04T11:40:00+01:00',time:'11:40',title:'Baixa-Chiado → 西班牙广场站 Praça de Espanha',sub:'蓝线直达；开始去车站',place:'ibis',icon:'🚇',core:true},
{iso:'2026-10-04T12:00:00+01:00',time:'12:00',title:'回 ibis 酒店取行李',sub:'12:15前完成',place:'ibis',icon:'🧳',core:true},
{iso:'2026-10-04T12:20:00+01:00',time:'~12:20',title:'西班牙广场站 Praça de Espanha → Santa Apolónia',sub:'蓝线直达；地铁异常时改 Uber/Bolt',place:'santa',icon:'🚇',core:true},
