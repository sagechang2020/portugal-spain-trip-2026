...
{id:'cr7',n:'⑦/⑭',day:'1001',lat:32.644306,lng:-16.913861,name:'C罗酒店',local:'Pestana CR7 Funchal',time:'10/1约15:00入住；10/2 12:00退房寄存、18:05后取行李',task:'rooftop/pool + 10/2行李锚点 / Inverse晚饭',icon:'🏊'},
...
{id:'quinta',n:'⑪',day:'1002',lat:32.66713,lng:-16.93816,name:'C罗童年社区',local:'Quinta Falcão · Centro Comunitário da Quinta Falcão',time:'10/2约13:20–13:50',task:'Ronaldo childhood neighborhood / mural context',icon:'⚽'},
{id:'pico',n:'⑫',day:'1002',lat:32.6677,lng:-16.9456,name:'皮库-杜斯巴塞洛斯观景台',local:'Miradouro do Pico dos Barcelos',time:'10/2约14:05–14:35',task:'Funchal / bay panorama',icon:'🌄'},
...
'1001':{label:'10/1 周四',subtitle:'Monte + CR7完整泳池 + 西海岸 + 19:30已订晚餐',items:[
...
{time:'~10:10',title:'Teleférico do Funchal 单程上山',sub:'约10:10–10:30',place:'cable',icon:'🚠',core:true},
{time:'~10:40',title:'Monte Palace Madeira',sub:'约10:40–12:40 · 保护完整约2小时',place:'monte',icon:'🌿',core:true},
{time:'~12:40',title:'开始叫 Uber → central Funchal',sub:'不再绕去 Quinta Falcão',place:'monte',icon:'📱'},
...
{time:'14:35',title:'CR7 lobby / check-in buffer',sub:'等15:00入住，不假设提前拿房',place:'cr7',icon:'🏨'},
{time:'15:00',title:'进房 / 换泳衣',sub:'15:00–15:20',place:'cr7',icon:'🩱'},
{time:'15:20',title:'Rooftop 干身拍照',sub:'15:20–15:40',place:'cr7',icon:'📷',core:true},
{time:'15:40',title:'Infinity pool',sub:'15:40–16:30 · 约50分钟实际下水，不压缩',place:'cr7',icon:'🏊',core:true},
{time:'16:30',title:'最后拍照 + 洗澡更衣',sub:'16:30–17:20',place:'cr7',icon:'🚿'},
{time:'17:20',title:'开始叫 Uber → Cabo Girão',sub:'预留等车',place:'cabo',icon:'📱'},
{time:'~17:55',title:'Cabo Girão Skywalk',sub:'约17:55–18:20；天气/能见度差直接删',place:'cabo',icon:'🌊'},
{time:'~18:25',title:'Uber → Câmara de Lobos',sub:'收尾时提前安排下一辆车',place:'camara',icon:'🚕'},
{time:'~18:40',title:'Câmara de Lobos 海湾',sub:'约18:40–19:05；只短走',place:'camara',icon:'🌅'},
...
'1002':{label:'10/2 周五',subtitle:'休息 + Ronaldo成长区域 + Museu CR7 + 21:20飞Lisbon',items:[
{time:'08:00',title:'Pestana CR7 早餐 buffet',sub:'08:00–08:40 · 正常早餐，不当 brunch',place:'cr7',icon:'☕',core:true},
{time:'08:45',title:'Private room / rest',sub:'08:45–11:15 · 故意留白的低压力休息块',place:'cr7',icon:'🫧',buffer:true},
{time:'11:15',title:'洗澡 / 最终打包 / 房间检查',sub:'到11:50；不要拖到最后十分钟',place:'cr7',icon:'🧳'},
{time:'11:50',title:'Check-out + 酒店寄存行李',sub:'12:00前完成；约18:20回来取',place:'cr7',icon:'🏨',core:true},
{time:'12:05',title:'正常午饭',sub:'12:05–13:05；CR7 / marina / central Funchal附近',place:'cr7',icon:'🍽️'},
{time:'~13:05',title:'开始叫 Uber → Quinta Falcão',sub:'前往 Santo António',place:'quinta',icon:'📱'},
{time:'~13:20',title:'Quinta Falcão · C罗童年社区',sub:'约13:20–13:50；社区/壁画/成长背景，不写成保存故居',place:'quinta',icon:'⚽'},
{time:'~13:50',title:'短程 Uber → Pico dos Barcelos',sub:'不强行走山路',place:'pico',icon:'🚕'},
{time:'~14:05',title:'Miradouro do Pico dos Barcelos',sub:'约14:05–14:35 · Funchal / bay panorama',place:'pico',icon:'🌄'},
{time:'~14:35',title:'Uber → Praça CR7 / museum area',sub:'目标14:55–15:05返回',place:'museum',icon:'🚕'},
{time:'15:10',title:'Museu CR7',sub:'15:10–16:00；住客权益到前台确认，否则正常购票',place:'museum',icon:'🏆',core:true},
{time:'16:00',title:'Praça CR7 / marina / coffee / souvenirs / rest',sub:'16:00–17:00 · 故意留白，不默认塞新景点',place:'cr7',icon:'🫧',buffer:true},
{time:'17:00',title:'提前晚饭',sub:'约17:00–18:05；默认 Inverse by CR7，允许就近替换',place:'cr7',icon:'🍔'},
{time:'18:05',title:'回前台取行李 / toilet / final check',sub:'18:05–18:25',place:'cr7',icon:'🧳'},
{time:'18:25',title:'最后缓冲',sub:'吸收晚饭服务稍慢；不要新增活动',place:'cr7',icon:'⏳',buffer:true},
{time:'~18:45',title:'开始叫 Uber / taxi → FNC',sub:'Uber慢就马上换taxi；最迟约19:00离开',place:'airport',icon:'📱',core:true},
...
{time:'23:00',title:'抵达 Lisbon',sub:'下一步只去 ibis Lisboa José Malhoa，不夜游',icon:'🌙'}]}}
;
