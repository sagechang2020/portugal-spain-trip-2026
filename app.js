...
{id:'vila',n:'⑩',day:'1001',lat:32.64912,lng:-16.97472,name:'Vila do Peixe 鱼餐厅',local:'Restaurante Vila do Peixe',time:'10/1 19:30',task:'已确认预约 · 2人',icon:'🐟'},
...
{time:'~21:00',title:'机场 → 马德拉酒店 Hotel Madeira',sub:'Uber；晚间不折腾公交',place:'hotel-madeira',icon:'🚕'},
{time:'~21:30',title:'马德拉酒店 Hotel Madeira 入住',sub:'前台时间临近出发再确认',place:'hotel-madeira',icon:'🏨',core:true},
{time:'21:45',title:'前往丰沙尔老城 Zona Velha / Rua de Santa Maria',sub:'只做轻量夜游',place:'oldtown',icon:'🚶'},
...
{time:'08:45',title:'马德拉酒店 Hotel Madeira 早餐',sub:'08:45–09:30 · 已包含',place:'hotel-madeira',icon:'☕'},
...
{time:'14:05',title:'回马德拉酒店 Hotel Madeira 取行李',sub:'14:15前完成',place:'hotel-madeira',icon:'🧳'},
{time:'14:15',title:'马德拉酒店 Hotel Madeira → Pestana CR7',sub:'带行李用短程 Uber',place:'cr7',icon:'🚕'},
...
{time:'17:20',title:'开始叫 Uber → 吉朗角 Cabo Girão',sub:'预留等车',place:'cabo',icon:'📱'},
{time:'~17:55',title:'吉朗角玻璃观景台 Cabo Girão',sub:'约17:55–18:20；天气/能见度差直接删',place:'cabo',icon:'🌊'},
{time:'~18:25',title:'Uber → 卡马拉-德洛布什 Câmara de Lobos',sub:'收尾时提前安排下一辆车',place:'camara',icon:'🚕'},
...
{time:'~13:05',title:'开始叫 Uber → C罗童年社区 Quinta Falcão',sub:'前往 Santo António',place:'quinta',icon:'📱'},
{time:'~13:20',title:'Quinta Falcão · C罗童年社区',sub:'约13:20–13:50；社区、壁画和C罗成长背景',place:'quinta',icon:'⚽'},
{time:'~13:50',title:'短程 Uber → Pico dos Barcelos 观景台',sub:'不强行走山路',place:'pico',icon:'🚕'},
...
{time:'~19:25',title:'抵达马德拉机场 FNC',sub:'目标19:25–19:40到；预留充足时间',place:'airport',icon:'🛂',core:true},
...
{title:'Pestana CR7 屋顶无边泳池',src:'https://www.pestana.com/content/dam/pestana/en_gb/destinations/portugal/madeira/pestana-cr7-funchal/gallery/overview/pestana-cr7-funchal-gallery-facilities-pool.jpg'},
...
{title:'Pico dos Barcelos 观景台',src:'https://upload.wikimedia.org/wikipedia/commons/d/df/Madeira_Pico_dos_Barcelos_2016_1.jpg'},
